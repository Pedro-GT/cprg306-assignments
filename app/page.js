  ...
  return (
    <main className = "items-center justify-center flex flex-col h-screen">
      ...
      <ul>
        ...
        <li className={linkStyle}><Link href={'./week-7'}>Week 7</Link></li>
        <li className={linkStyle}><Link href={'./week-8'}>Week 8</Link></li>
        <li className={linkStyle}><Link href={'./week-9'}>Week 9</Link></li>
      </ul>
    </main>
  );
}
